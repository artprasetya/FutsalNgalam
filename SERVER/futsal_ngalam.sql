...
<span id="page_nav_icons"><span id="lock_page_icon"></span><span id="page_settings_icon"><img src="themes/dot.gif" title="Page-related settings" alt="Page-related settings" class="icon ic_s_cog" /></span><a id="goto_pagetop" href="#"><img src="themes/dot.gif" title="Click on the bar to scroll to top of page" alt="Click on the bar to scroll to top of page" class="icon ic_s_top" /></a></span><div id="pma_console_container">
    <div id="pma_console">
        ...
        <div class="content">
            <div class="console_message_container">
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        ...
                        targetdb="futsal_ngalam" targettable="tempat_futsal">
            ...
            Database                            : <span> futsal_ngalam </span>
                    </span>
            <span class="text query_time">
            Queried time                            : <span> During current session </span>
                    </span>
    </div>
                        <span class="query"> SELECT * FROM `tempat_futsal` </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="tarif">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> CREATE TABLE `futsal_ngalam`.`tarif` ( `id_tarif` INT(5) NOT NULL ,  `harga_sewa` DOUBLE NOT NULL ,    PRIMARY KEY  (`id_tarif`)) ENGINE = InnoDB; </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="futsal_ngalam" targettable="tarif">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tarif` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="futsal_ngalam" targettable="tarif">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> ALTER TABLE `tarif` ADD INDEX(`id_tempat_futsal`); </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="tarif">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> ALTER TABLE `tarif` ADD INDEX(`id_lapangan`); </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="feedback">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> CREATE TABLE `futsal_ngalam`.`feedback` ( `id_feedback` INT(5) NOT NULL ,  `review` TEXT NOT NULL ,  `rating` INT(10) NOT NULL ,  `id_tempat_futsal` INT(5) NOT NULL ,    PRIMARY KEY  (`id_feedback`)) ENGINE = InnoDB; </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="feedback">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> ALTER TABLE `feedback` ADD INDEX(`id_tempat_futsal`); </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="pemesanan">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> CREATE TABLE `futsal_ngalam`.`pemesanan` ( `id_pemesanan` INT(5) NOT NULL ,  `id_pemakaian` INT(5) NOT NULL ,  `id_tarif` INT(5) NOT NULL ,    PRIMARY KEY  (`id_pemesanan`)) ENGINE = InnoDB; </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="pemesanan">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> ALTER TABLE `pemesanan` ADD INDEX(`id_pemakaian`); </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="pemesanan">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> ALTER TABLE `pemesanan` ADD INDEX(`id_tarif`); </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="pembayaran">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> CREATE TABLE `futsal_ngalam`.`pembayaran` ( `id_pembayaran` INT(5) NOT NULL ,  `id_pemesanan` INT(5) NOT NULL ,  `status` BOOLEAN NOT NULL ,    PRIMARY KEY  (`id_pembayaran`)) ENGINE = InnoDB; </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="futsal_ngalam" targettable="pembayaran">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `pembayaran` </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="pembayaran">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> ALTER TABLE `pembayaran` ADD INDEX(`id_pemesanan`); </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="futsal_ngalam" targettable="tempat_futsal">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `tempat_futsal`(`id_tempat_futsal`, `nama`, `alamat`) VALUES (1,&quot;Zona SM&quot;,&quot;Sudimoro Malang&quot;) </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="tempat_futsal">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `tempat_futsal`(`id_tempat_futsal`, `nama`, `alamat`) VALUES (2,&quot;Viva Futsal&quot;,&quot;Soekarno Hatta Malang&quot;) </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="tempat_futsal">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `tempat_futsal`(`id_tempat_futsal`, `nama`, `alamat`) VALUES (3,&quot;Champion Arena Tidar&quot;,&quot;Tidar Malang&quot;) </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="futsal_ngalam" targettable="petugas">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `petugas` </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="petugas">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `petugas`(`id_petugas`, `password`, `id_tempat_futsal`) VALUES (&quot;zonasm&quot;,&quot;admin&quot;,1) </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="petugas">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `petugas`(`id_petugas`, `password`, `id_tempat_futsal`) VALUES (&quot;viva&quot;,&quot;admin&quot;,2) </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="petugas">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `petugas`(`id_petugas`, `password`, `id_tempat_futsal`) VALUES (&quot;tidar&quot;,&quot;admin&quot;,3) </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="futsal_ngalam" targettable="lapangan">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `lapangan` </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="lapangan">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `lapangan`(`id_lapangan`, `jenis`) VALUES (1,&quot;Lapangan Besar&quot;) </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="futsal_ngalam" targettable="lapangan">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `lapangan`(`id_lapangan`, `jenis`) VALUES (2,&quot;Lapangan Kecil&quot;) </span>
                    </div>
